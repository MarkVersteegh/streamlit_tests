...
st.video(data)
    ...
    col1.markdown('__Pre-release features__')
    col1.markdown('[Beta and experimental features](https://docs.streamlit.io/en/0.70.0/api.html#beta-and-experimental-features)')
    col1.code('''
...
>>>     st.write('Code will be executed and printed')
    ...
    # Sidebar
    col2.markdown('__Add widgets to sidebar__')
    col2.code('''
st.sidebar.<widget>
...
>>> d3 = foo(ref2)
    ...
    col3.markdown('__Command line__')
    col3.code('''
$ streamlit --help
